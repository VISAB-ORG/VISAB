...
public class PathViewerWindowController {
	...
	private Image imageScriptBot = new Image("file:img/scriptBot.png");

	private Image deathImage = new Image("file:img/deathScript.png");

	private Image deathImageCBR = new Image("file:img/deadCBR.png");

	private Image imageCbrBot = new Image("file:img/cbrBot.png");

	private Image changePlanCBRImage = new Image("file:img/changePlan.png");

	private Image changePlanScriptImage = new Image("file:img/changePlan.png");
	...
	public void handleShowCoordinates() {
	...
	private void loadVisabStatistics(String content) {
		...
		pauseImage = new Image("file:img/pause.png");
