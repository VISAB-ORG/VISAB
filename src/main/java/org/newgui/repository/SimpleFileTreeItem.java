...
public class SimpleFileTreeItem extends TreeItem<File> {
     ...
     * TreeItem<File>.
     * 
     * @param f an object of type File from which a tree should be build or which
     *          children should be gotten.
     */
     ...
     *         represent all children available in handed TreeItem. If the handed
     *         TreeItem is a leaf, an empty list is returned.
     */
