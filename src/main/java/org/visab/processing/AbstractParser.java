...
/**
 * Abstract parser class that can be extended by any game-specific parser to
 * handle the full functionality of transforming data received by the unity
 * games into VISAB-conform file format.
 *
 * @author leonr
 *
 */
public abstract class AbstractParser {
    ...
    /**
     * The Gson object responsible for deserializing the JSON String into the
     * respective JAVA representation.
     */
    protected Gson gson;
    ...
    /**
     * Responsible for closing the output stream and flushing the content to the
     * file.
     *
