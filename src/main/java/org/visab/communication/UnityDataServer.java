...
/**
 *
 * This class represents a server application that gets started if VISAB
 * operates in headless mode. By listening on a specific port it can receive
 * data from the Unity game via TCP/IP based socket communication.
 *
 * @author leonr
 *
 */
public class UnityDataServer {
    ...
    private String game;
    /**
     * The absolute path for the desired output directory for .visab file
     * generation.
     */
