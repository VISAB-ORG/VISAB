...
public final class SettlersImplicator {
    ...
    private static List<Series<String, Number>> createResourceSeries(List<StatisticsData<PlayerResources>> player1Data,
        ...
        for (int i = 0; i < player1Data.size(); i++) {
            ...
            woodSeries.getData().add(new XYChart.Data<String, Number>(String.valueOf(i + 1) + " - Player 1",
                    resourcesPlayer1.getWood()));
            woodSeries.getData().add(new XYChart.Data<String, Number>(String.valueOf(i + 1) + " - Player 2",
                    resourcesPlayer2.getWood()));
            sheepSeries.getData().add(new XYChart.Data<String, Number>(String.valueOf(i + 1) + " - Player 1",
                    resourcesPlayer1.getSheep()));
            sheepSeries.getData().add(new XYChart.Data<String, Number>(String.valueOf(i + 1) + " - Player 2",
                    resourcesPlayer2.getSheep()));
            stoneSeries.getData().add(new XYChart.Data<String, Number>(String.valueOf(i + 1) + " - Player 1",
                    resourcesPlayer1.getStone()));
            stoneSeries.getData().add(new XYChart.Data<String, Number>(String.valueOf(i + 1) + " - Player 2",
                    resourcesPlayer2.getStone()));
            wheatSeries.getData().add(new XYChart.Data<String, Number>(String.valueOf(i + 1) + " - Player 1",
                    resourcesPlayer1.getWheat()));
            wheatSeries.getData().add(new XYChart.Data<String, Number>(String.valueOf(i + 1) + " - Player 2",
                    resourcesPlayer2.getWheat()));
            brickSeries.getData().add(new XYChart.Data<String, Number>(String.valueOf(i + 1) + " - Player 1",
                    resourcesPlayer1.getBrick()));
            brickSeries.getData().add(new XYChart.Data<String, Number>(String.valueOf(i + 1) + " - Player 2",
                    resourcesPlayer2.getBrick()));
        }
