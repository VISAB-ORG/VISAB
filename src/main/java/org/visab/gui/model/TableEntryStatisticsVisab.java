...
/**
 * POJO for a single Table entry of statistics containing information on both,
 * the script bot and the cbr bot, in the StatisticView.
 * 
 * @author VISAB 1.0 group
 *
 */
public class TableEntryStatisticsVisab {
